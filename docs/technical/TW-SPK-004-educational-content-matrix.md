...
- The runtime canonicalizer has no DA/RA alias, and `TemplateLoader` groups DA and RA template IDs independently; discrepancy D-009 assigns the unified runtime-identity follow-up to SALIN-170 and the recognition owner.
